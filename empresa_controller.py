...
@router.post("/", response_model=EmpresaCreate, status_code=201, summary="Criar uma nova empresa",
...
@router.put("/{empresa_id}", response_model=EmpresaCreate, status_code=200, summary="Atualizar uma empresa",
...
@router.delete("/{empresa_id}", status_code=200, summary="Deletar uma empresa",
